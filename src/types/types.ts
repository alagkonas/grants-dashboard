// This file should be autogenerated every time changes happen to BE
// Best way using a smart contract, e.g. OpenApi
// For the purpose of this task, we just copy-paste the files in ./src/shared/types directory in dashboard-agents-api repo
